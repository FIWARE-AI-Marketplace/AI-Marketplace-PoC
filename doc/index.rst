...
The current documentation covers the Business API Ecosystem version 7.6.0, corresponding to FIWARE release 7. Any feedback on this document is highly welcomed, including bugs,
